...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/pricing.css?v=<?php echo @filemtime(__DIR__ . '/../../public/assets/css/pricing.css') ?: time(); ?>">
    <!-- Pricing Page Internationalization (must load before inline scripts) -->
    <script src="/assets/js/i18n/subscription/pricing-i18n.js?v=<?php echo @filemtime(__DIR__ . '/../../public/assets/js/i18n/subscription/pricing-i18n.js') ?: time(); ?>"></script>
    <!-- UseePay SDK -->
